local mpsconf={
	...
	talimatdepo={
		...
		-- tname düzeylere göre
		 ...
		 [3]={["https://mls.akdeniz.edu.tr/git/milis-topluluk/mkd21"]="talimatname"},
		
	},
	betikdepo={
		-- ilgili repodan bin/ ayarlar/ gibi betik içeren dizinlerin alınması
		bin={["https://mls.akdeniz.edu.tr/git/milislinux/milis21"]="bin",["https://mls.akdeniz.edu.tr/git/milis-topluluk/mkd21"]="bin"},
